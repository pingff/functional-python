# Functional Python [![](https://github.com/mikeizbicki/functional-python/workflows/tests/badge.svg)](https://github.com/pingff/functional-python/actions?query=workflow%3Atests)
